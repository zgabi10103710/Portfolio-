<template>
  <section class="hero container has-ellipse-curve">
    <div class="hero-content">
      <h1 class="hero__headline">Je suis Gabriel Briziou</h1>
      <p class="hero__description">
      Je suis un Pentester curieux et passionné, toujours à la recherche de
      nouvelles façons de découvrir et de corriger les vulnérabilités de sécurité
      dans les systèmes informatiques et les applications Web.
      </p>
      <SocialMediaIcons />
    </div>
    <div class="hero-aside">
      <ScrollIndicator class="is-mobile-only" />
      <h2 class="hero__subheadline">Pentester</h2>
      <HeroAvatar>
        <img
