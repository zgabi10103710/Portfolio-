<template>
  <main class="main" ref="main">
    <div class="hero">
      <div class="container">
        <h1 class="hero__headline">Write-up & Tuto</h1>
        <p class="hero__description">
          je vais partager mon expérience de participation au CTF et présenter les différentes vulnérabilités et défis que j'ai rencontrés en sécurisant un site web. Je vais expliquer les techniques de piratage que j'ai utilisées pour trouver ces vulnérabilités et les solutions que j'ai mises en place pour les corriger. Si vous êtes intéressé par la sécurité web et souhaitez en savoir plus sur les meilleures pratiques de défense, ce Write-up est pour vous ! J'espère que cette lecture sera informative et vous donnera une meilleure compréhension de la sécurité web.
        </p>
      </div>
    </div>
